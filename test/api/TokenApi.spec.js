...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TradersRoomPartnerApi.TokenApi();
  });
    ...
    describe('TokenApi', function() {
      describe('tokenGet', function() {
        it('should call tokenGet successfully', function(done) {
          // TODO: uncomment, update parameter values for tokenGet call and complete the assertions
          /*

          instance.tokenGet(programId, jti, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(TradersRoomPartnerApi.TokenItem);
